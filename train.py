...
class GeneticOptimizer:
    ...
    def evolve(self):
        ...
        print(json.dumps(self.best_genome.genes, indent=4))
        
        with open('best_autopilot_params.json', 'w') as f:
            json.dump(self.best_genome.genes, f, indent=4)
            print("Saved to best_autopilot_params.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume', action='store_true', help='Resume training from best_autopilot_params.json')
    parser.add_argument('--generations', type=int, default=GENERATIONS, help='Number of generations')
